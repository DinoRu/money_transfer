...
Revision ID: 5afba2fc8ca4
Revises: 
Create Date: 2025-04-11 12:28:20.874283
...
def upgrade() -> None:
    ...
    sa.Column('sender_amount', sa.DECIMAL(precision=10, scale=2), nullable=True),
    ...
    sa.Column('receiver_amount', sa.DECIMAL(precision=10, scale=2), nullable=True),
